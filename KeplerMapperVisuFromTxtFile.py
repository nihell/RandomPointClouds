...
with open(args.file, 'r') as f:
    ...
    with open(args.file.rsplit('.', 1)[0] + '.json', "w") as f2:
        json.dump(network, f2, indent=4)
        f2.close()
    ...
    height_html=0, show_tooltips=True, show_title=False, show_meta=True, res=param[0],gain=param[1], minimum=m,maximum=M)
